...
class VoxPoserRLBench():
    ...
    def load_task(self, task):
        ...
        print("[DEBUG] task name : " + self.task.get_name() + "name_mapping: " , name_mapping)
        print("[DEBUG] rlbench_env.load_task. scene_objs:  ", [scene_obj.get_name() for scene_obj in  scene_objs])
        print("[DEBUG] rlbench_env.load_task. exposed_names :", exposed_names, "\tinternal_names: ", internal_names)
        ...
        print("[DEBUG] rlbench_env.load_task. self.name2ids, self.id2names: ", self.name2ids, self.id2name)
    ...
    def get_3d_obs_by_name(self, query_name):
        ...
        """
        print("[DEBUG] rlbench_env.get_3d_obs_by_name, self.name2ids: ", self.name2ids)
